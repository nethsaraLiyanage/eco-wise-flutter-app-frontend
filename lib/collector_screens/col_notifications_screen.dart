...
class ColNotificationsScreen extends ConsumerStatefulWidget {
  const ColNotificationsScreen({
    super.key,
  ...
  @override
  ConsumerState<ColNotificationsScreen> createState() =>
      _ColNotificationsScreenState();
}

class _ColNotificationsScreenState
    extends ConsumerState<ColNotificationsScreen> {
  @override
  void initState() {
  ...
  final notifications = [
    LocalNotification(
      ...
      time: '1m',
      content:
          'Friendly reminder: Your e-waste pickup is scheduled for tomorrow at 9 AM.  Please ensure your items are ready for collection',
      isRead: false,
    ),
    LocalNotification(
